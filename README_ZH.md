...
| 文件 | 行數 | 說明 |
|------|------|------|
| `mlx_video_ocr/app.py` | 74 | Flask 應用設定 |
| `mlx_video_ocr/routes/*.py` | 1,136 | API 路由 |
| `static/app.js` | 3,207 | 前端邏輯、UI 互動 |
| `templates/index.html` | 859 | HTML 結構、樣式 |
| **總計** | **5,276** | 完整功能實現 |
